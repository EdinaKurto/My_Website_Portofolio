  ...
  return (
    <div className="min-h-screen py-24 px-6 relative overflow-hidden film-grain">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute bottom-20 left-20 w-80 h-80 rounded-full border border-[#FFC7A8] animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {/* Contact Form */}
        <div className="card-warm backdrop-blur-sm p-8 md:p-12 border border-[#C5A9FF]/30 glow-warm">
          ...
          <div className="absolute bottom-4 left-4 w-1.5 h-1.5 bg-[#FFC7A8] rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
        </div>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <div className="card-warm backdrop-blur-sm p-6 border border-[#C5A9FF]/20 text-center hover:border-[#C5A9FF]/50 transition-all duration-300 hover:glow-warm hover:scale-105">
            ...
            <p className="text-white/60 text-sm">hello@avellox.studio</p>
          </div>
