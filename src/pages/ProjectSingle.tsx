...
export function ProjectSingle() {
  ...
  const project = Number.isNaN(numericId) ? undefined : getProjectById(numericId);
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center space-y-4 text-white">
          ...
          <button
            ...
            className="text-[#C5A9FF] underline">Back to Projects</button>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen py-24 px-6 film-grain relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <button
          ...
          <ArrowLeft size={20} className="group-hover:-translate-x-1 transition-transform" />Back to Projects</button>
        ...
        <div className="mb-12">
          ...
          <h1 className="text-5xl md:text-6xl text-white mb-4">{project.title}</h1>
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="md:col-span-2 space-y-6">
              <p className="text-white/80 text-lg leading-relaxed">{project.overview.description}</p>
            </div>
        ...
        <section className="mb-20">
          ...
          <div className="card-warm p-8 border border-[#C5A9FF]/20">
            <p className="text-white/80 text-lg leading-relaxed mb-8">{project.process.description}</p>
        ...
        <section>
          <div className="card-warm p-8 border border-[#3A6FF7]/30 text-center gradient-warm">
            ...
            <CustomButton
              onClick={() => navigate('/projects')}
              variant="primary"
              className="mx-auto flex items-center gap-2 group">View More Projects
              <ArrowRight
                size={20}
