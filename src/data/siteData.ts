...
This game was made for the O2A2 VN Jam 2024, a micro visual novel jam with strict asset limitations and a 1,000-word limit.`,
    cover: stayCover,
    gallery: [stay1, stay2],
    role: "Game Developer / Lead Game Designer",
    engine: "Ren'Py",
    perspective: "Visual Novel",
  ...
  },
  {
    ...
    status: "Released",
    description:
      "A co-op mythic action adventure about family, folklore and surviving the city with garlic, courage and a little divine help.",
    longDescription:
      "Ethos Mythos blends co-op combat, Balkan folklore and urban fantasy into a fast, characterful action experience. Choose from a trio of fighters — a grandmother wielding a wooden spoon, a salt master, and a garlic ranger — each with their own fighting style and combo potential. Fight through the family home, push out into the polluted streets, and survive encounters that test both your teamwork and your endurance. As you progress, divine blessings from gods like Perun, Morana and Vesna transform your abilities and deepen the combat loop.",
    cover: EM,
    gallery: [EM],
    role: "Game Developer / Lead GameDesigner",
    engine: "Unity · C#",
    perspective: "Third Person",
    tags: ["Co-op", "Action Adventure", "Folklore"],
    features: [
      "Team-based combat",
      "Distinct playable characters",
      "Mythic god blessings",
      "Balkan-inspired worldbuilding",
    ],
    process: [
      {
        title: "Worldbuilding",
        description:
          "Designing a fantasy setting where belief, family and culture shape both the world and the player's decisions.",
      },
      {
        title: "Systems",
        description:
          "Balancing character differentiation, co-op teamwork and progression so the combat remains readable and satisfying.",
      },
    ],
