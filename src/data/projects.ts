...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tagline: 'A magical match-3 adventure about cleaning up one very bad potion accident.',
    shortDescription:
  ...
  },
  {
    ...
    tagline: 'A quiet, emotional micro–visual novel about love, mistakes, and second chances.',
    shortDescription: 'A branching narrative about helping two people decide if their relationship is worth saving.',
    category: 'Games',
    ...
    features: [
      {
        ...
        description: 'Decide whether to support Vincent’s doubts or encourage him to repair the relationship—leading to two different endings.',
      },
      {
        icon: Palette,
        title: 'Emotional Voice Acting',
        description: 'The story is brought to life with expressive voice performance by SpoopiIzumi.',
      },
      {
        icon: Sparkles,
        title: 'Micro VN Format',
        description: 'Created for O2A2 VN Jam 2024 with strict limitations: 1000 words, 1 sprite, 1 BG, 1 music track, 1 VA.',
      },
    ],
    process: {
      description:
