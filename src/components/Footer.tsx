    ...
    <footer className="bg-[#0D1018] border-t border-[#C5A9FF]/20 py-12">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col items-center md:items-start gap-2">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white font-semibold">Avellox Studio</span>
            </div>
            <p className="text-white/50 text-sm flex items-center gap-1">
              © 2025 Avellox Studio. Made with <Heart size={14} className="text-[#FFC7A8] fill-[#FFC7A8]" />
            </p>
          </div>
        ...
        <div className="text-center mt-8 text-white/40 text-sm">
          Crafting cozy interactive worlds & visual stories ✨
        </div>
      </div>
    </footer>
  );
